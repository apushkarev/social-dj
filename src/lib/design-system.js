...
export const ds = {
  ...
  /* Overlays */
  '--overlay1': 'rgba(255, 255, 255, 0.01)',   // 10 ** -2
  '--overlay2': 'rgba(255, 255, 255, 0.025)',  // 10 ** -1.6
  '--overlay3': 'rgba(255, 255, 255, 0.05)',   // 10 ** -1.3
  '--overlay4': 'rgba(255, 255, 255, 0.1)',    // 10 ** -1
  '--overlay5': 'rgba(255, 255, 255, 0.16)',   // 10 ** -0.8
  '--overlay6': 'rgba(255, 255, 255, 0.25)',   // 10 ** -0.6
  '--overlay7': 'rgba(255, 255, 255, 0.4)',    // 10 ** -0.4
  '--overlay8': 'rgba(255, 255, 255, 0.63)',   // 10 ** -0.2

  /* Borders */
  '--border0': 'rgba(255, 255, 255, 0.01)',
